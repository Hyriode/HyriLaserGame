...
public class LGBonusEntity {
    ...
    public LGBonusEntity(ArmorStand armorStand, Location location, HyriLaserGame plugin){
        this.armorStand = armorStand;
        this.location = location;
        this.plugin = plugin;
    }

    public static LGBonusEntity spawn(Location location, HyriLaserGame plugin){
        ...
        LGBonusEntity bonus = new LGBonusEntity(armorStand, location, plugin);
